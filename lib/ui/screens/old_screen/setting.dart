...
class OldSetting extends StatefulWidget {
  bool isMusicOn;
  bool isNotificationOn;
  bool isSfxOn;
  String memberId;

  OldSetting(bool isMusicOn, bool isNotificationOn, bool isSfxOn, String memberId) {
  ...
  @override
  _OldSettingState createState() => _OldSettingState();
}

class _OldSettingState extends State<OldSetting> {
  @override
  void initState() {
    super.initState();
  ...
  void turnOnOffNotificationByApi(bool onOffValue) async {
    try {
      ...
      showToast(context, 'Notification is off. But you will still get Battle challenges from friends.');
    } catch (e) {
      print(e);
    }
  }
