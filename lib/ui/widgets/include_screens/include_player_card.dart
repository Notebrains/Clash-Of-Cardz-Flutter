...
Widget buildPlayerCard(BuildContext context, List<Cards> cardsList, {
              ...
              Align(
                ...
                child: GridView.count(
                  ...
                  children: List.generate(
                      cardsAttributeList[0].length, (index) {
                    return Container(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: (){
                          onClickAction(index.toString(), cardsAttributeList[0][index].name, cardsAttributeList[0][index].value, '0PLY002');
                        },
                      ),
                    );
                  }).toList(),
...
Widget buildPlayerTwoCard(BuildContext context, List<Cards> cardsList, {
                  ...
                  children: List.generate(8, (index) {
                    return Container(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: (){
                          onClickActionP2(index.toString(), 'Match', matches[index], '0PLY002');
                        },
                      ),
                    );
                  }).toList(),
